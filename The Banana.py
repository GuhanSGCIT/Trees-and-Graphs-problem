"""
Ram has a string S of length N, consisting of only characters a and b for banana and P points to spend.
Now Ram wants to replace and/or re-arrange characters of this given string to get the lexicographically smallest string possible.
